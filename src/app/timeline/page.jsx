              ...
              {tab === 1 ? (
                <div>
                  ...
                  <div className="w-full">
                    ...
                    <Link
                      href={`/contact-us/${userID}`}
                      className="flex items-center gap-x-4 p-4 rounded-lg border w-full max-w-[400px] mt-4 cursor-pointer"
                    >
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex justify-between items-center">
                    <p className="text-gray-300">Total Weight</p>
                    <p className="text-gray-300">
                      {data?.data?.order?.totalWeight}lbs
                    </p>
                  </div>
                  <div className="flex justify-between items-center">
                    <p className="text-gray-300">Shipping Charges</p>
                    <p className="text-gray-300">
                      ${data?.data?.order?.shippingCharges}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <Link
                      href={`/contact-us/${userID}`}
                      className="flex items-center gap-x-4 p-4 rounded-lg border w-max mt-4 cursor-pointer"
                    >
